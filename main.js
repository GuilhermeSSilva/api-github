...
function listaUsuario(section,usuario,div,img,nome,seguidores){
    ...
    let botaoStarred=$("<button>").attr("onclick",`listaStarred('http://api.github.com/users/${usuario.login}/starred')`).text("Starred").addClass("section__botoes section__botao__starred");
    div.append(img);
    div.append(nome);
